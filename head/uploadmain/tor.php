...
if(isset($_FILES["image"])) {
    ...
    $sql = "INSERT INTO `tbl_tor` (`image`, `file_id`, `username`, `date`, `name`, `type`) VALUES ('" . $blob . "', '" . $file_id . "' , '" . $username . "', '" . $date . "', '" . $name . "' , '" . $type ."')";
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_object($result))
        {
            ...
            <tr>
                ...
                <td>
                <a class="btn-button" href="delete/delete_tor.php?id=<?php echo $row->id; ?>" onclick="showConfirmation(event)">DELETE</a>
                </td>
            </tr>
            <?php
        }
