...
if(isset($_FILES["image"])) {
    ...
    $sql = "INSERT INTO `tbl_marriageesu` (`image`, `file_id`, `username`, `date`, `name`, `type`) VALUES ('" . $blob . "', '" . $file_id . "' , '" . $username . "', '" . $date . "', '" . $name . "' , '" . $type ."')";
...
$sql = "SELECT id, name FROM `tbl_marriageesu` where file_id=$file_id";
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_object($result))
        {
            ...
            <tr>
                ...
                <td>
                    <a href="../views/marriageesu.php?id=<?php echo $row->id; ?>" target="_blank">
                    <buttons class="btn-button">VIEW</buttons>
                    </a>
                </td>
                <td>
                <a class="btn-button" href="delete/delete_marriageesu.php?id=<?php echo $row->id; ?>" onclick="showConfirmation(event)">DELETE</a>
                </td>
            </tr>
            <?php
        }
