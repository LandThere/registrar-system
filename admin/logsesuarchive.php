...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            ...
            <a href="archiveesu.php" style="display: inline-block;">
                ...
                <br>
                <?php
                      $select = "SELECT stdesu_logs.*, college.code AS college_code FROM stdesu_logs LEFT JOIN college ON stdesu_logs.college = college.id WHERE log_id=$id";
                      if (isset($_POST['selected_college']) && $_POST['selected_college'] != 'all') {
                        $select .= " AND stdesu_logs.college = " . $_POST['selected_college'];
                      }
                      $result = mysqli_query($conn, $select);
